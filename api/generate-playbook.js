...
- Half-court viewBox "0 0 520 420" (or "0 0 520 500" for full court). You'll be told this phase's basket position: DOWN (default) or UP. Draw a simple court outline using whichever anchor set matches -- rect border, key/paint rectangle, free-throw circle, three-point line, basket, backboard line -- all in stroke #27364a, fill none, stroke-width 1.5-2:
  ...
  Full court: defensive basket (top) -- baseline y=6, backboard y=18, basket cy=28, key x=207 y=6 width=106 height=112. Attacking basket (bottom) -- baseline y=494, backboard y=482, basket cy=472, key x=207 y=382 width=106 height=112. Half-court line y=252, center circle cx=260 cy=252 r=30.- Three-point line: always a true circular arc centered on that basket, never a generic curve. Scale: 8.83 SVG units = 1 real foot (matches the key's 106-unit width = 12 ft). Use these real distances from the basket, by this play's coaching level (top-of-arc distance / corner distance):
